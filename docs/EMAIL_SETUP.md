...
2. Open the user (e.g. **admin@vrocure.co.uk**) in the detail drawer.
...
### Only admin locked out (e.g. admin@vrocure.co.uk)
...
5. In the app go to **Control Centre** → **User Management** → open the original admin (e.g. admin@vrocure.co.uk) → **Set password** and set a new password.
