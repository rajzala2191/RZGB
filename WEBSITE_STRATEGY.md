...
```
RZ Global Solutions builds manufacturing procurement
software for companies that buy custom parts.
...
- `[productname].com` — the software product

Option B matches the OpenAI/ChatGPT separation model and is the cleaner
long-term move. See `MASTER_PLAN.md` and the business strategy notes for
product naming guidance.

---

### Priority 6 — Add an About Page with the Founder Story (2 hours)

No company story is visible anywhere. The About page should explain:

- The founder worked in / around manufacturing procurement and felt the pain
  of managing suppliers over email and spreadsheets
- The software was built to solve that problem from the inside
- Sourcing services are also available for clients who need them
- Team photos and names

A face and a name converts far better than a faceless company page. This is
free to add and immediately increases credibility with both software buyers
and potential enterprise customers.

---

### Priority 7 — Add Trust Signals (ongoing)

No social proof is visible anywhere on the site. Add:

- 2–3 short customer quotes (pilot or beta users qualify)
- Logos of companies worked with (with permission)
- Any trade body memberships, certifications, or press mentions
...
| 8        | Launch separate product domain                  | Strategic |
...
- `MASTER_PLAN.md` — technical implementation roadmap (Phases 0–9)
- Business strategy discussion — company vs product identity, pricing model,
  ICP, go-to-market sequencing

The website is the front door. Until it reflects the software product, every
