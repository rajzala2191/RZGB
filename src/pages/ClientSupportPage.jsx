  ...
  return (
    <ClientDashboardLayout>
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">We're here to help with your orders and platform questions.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-4 text-slate-500 text-sm">
              ...
              <div className="pt-4 border-t border-slate-200">
                <p className="font-bold text-slate-700">Support Hours</p>
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
            <h3 className="font-bold text-slate-900 mb-6">Create New Ticket</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400/20 transition-all"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-slate-900 focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400/20 transition-all"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-slate-900 placeholder-slate-400 min-h-[120px] focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400/20 transition-all resize-none"
              ...
              <button
                disabled={submitting}
                type="submit"
                className="bg-orange-600 hover:bg-orange-500 active:scale-[0.98] text-white font-bold py-2 px-6 rounded-lg flex items-center gap-2 disabled:opacity-50 transition-all shadow-sm hover:shadow"
              >
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
            <div className="p-4 border-b border-slate-200 font-bold text-slate-700">My Tickets</div>
            {loading ? (
              <div className="p-8 flex justify-center"><Loader2 className="animate-spin text-orange-500" /></div>
            ) : tickets.length === 0 ? (
              <div className="p-8 text-center text-slate-400">No support history.</div>
            ) : (
              <div className="divide-y divide-slate-100">
                {tickets.map(t => (
                  ...
                  >
                    ...
                    <ChevronRight size={16} className="text-slate-300 flex-shrink-0 ml-3" />
                  </div>
                ))}
              </div>
            )}
