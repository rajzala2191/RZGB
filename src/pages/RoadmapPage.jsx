...
export default function RoadmapPage() {
  return (
    <div className="min-h-screen font-sans antialiased" style={{ fontFamily: "'DM Sans', sans-serif", background: 'var(--app-bg, #ffffff)' }}>
      <nav className="border-b border-gray-200 dark:border-[#232329]" style={{ background: 'var(--header-bg)' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <Link to="/landing" className="flex items-center gap-2 text-sm font-medium text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-slate-100 transition-colors">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-20 text-center">
        ...
        <h1 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-slate-100 mb-3">
          Product Roadmap
        </h1>
