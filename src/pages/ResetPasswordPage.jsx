...
const ResetPasswordPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Reset Password - RZ Global Solutions</title>
      </Helmet>
          ...
          <div className="bg-[#111111] rounded-xl shadow-2xl p-8 border border-gray-800">
            {done ? (
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600 text-xs">If this takes too long, your link may have expired. Please request a new one.</p>
