...
const DEMO_ROLES = [
  { key: 'client',   label: 'Client Portal',  icon: '🧑‍💼', email: 'demo.client@rzglobalsolutions.co.uk',   dash: '/client-dashboard' },
  { key: 'admin',    label: 'Control Centre', icon: '🛡️',  email: 'demo.admin@rzglobalsolutions.co.uk',    dash: '/control-centre' },
