...
const DEMO_ROLES = [
  { key: 'client',   label: 'Client Portal',   email: 'demo.client@rzglobalsolutions.co.uk',   dash: '/client-dashboard' },
  { key: 'admin',    label: 'Control Centre',   email: 'demo.admin@rzglobalsolutions.co.uk',    dash: '/control-centre' },
  { key: 'supplier', label: 'Supplier Hub',     email: 'demo.supplier@rzglobalsolutions.co.uk', dash: '/supplier-hub' },
];
...
export default function DemoBanner() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 bg-black/20 rounded-full p-1 flex-shrink-0">
        {DEMO_ROLES.map((r) => (
          <button
            key={r.key}
