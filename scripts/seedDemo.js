...
const SUPER_ADMIN_EMAIL    = 'admin@rzglobalsolutions.co.uk';
...
async function run() {
  ...
  console.log('  Client:   demo.client@rzglobalsolutions.co.uk   /  RZDemo2024!');
  console.log('  Admin:    demo.admin@rzglobalsolutions.co.uk    /  RZDemo2024!');
  console.log('  Supplier: demo.supplier@rzglobalsolutions.co.uk /  RZDemo2024!');
